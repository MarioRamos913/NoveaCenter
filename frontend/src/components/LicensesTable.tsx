...
export default function LicensesTable({ licenses, updateStatus, deleteLicense }: LicensesTableProps) {
    ...
    return (
        <section className="col-span-1 lg:col-span-8">
            <div className="glass-panel rounded-2xl p-8 min-h-[600px] flex flex-col h-[800px]">
                            ...
                            {rowVirtualizer.getVirtualItems().map((virtualRow) => {
                                ...
                                return (
                                    <div
                                        ...
                                        className="flex hover:bg-white/[0.02] transition-colors group border-b border-white/5 items-center"
                                    >
                                        ...
                                        <div className="w-[15%] px-6 text-center">
                                            <span className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-[10px] font-bold border backdrop-blur-md shadow-sm
                                                ${lic.status === 'active'
